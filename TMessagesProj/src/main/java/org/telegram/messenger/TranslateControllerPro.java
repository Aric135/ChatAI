...
public class TranslateControllerPro extends BaseController {
    ...
    public TranslateControllerPro(MessagesController messagesController) {
    ...
    public void setDialogTranslateTo(long dialogId, String language) {
        ...
        if (wasTranslating) {
            AndroidUtilities.runOnUIThread(() -> {
                synchronized (TranslateControllerPro.this) {
